...
void VulkanSwapchain::init(VulkanContext* ctx, GLFWwindow* win) {
    context = ctx;
    window = win;

    std::cout << "Initializing VulkanSwapchain..." << std::endl;
...
void VulkanSwapchain::cleanup() {
    std::cout << "Cleaning up VulkanSwapchain..." << std::endl;
    ...
    std::cout << "VulkanSwapchain cleaned up." << std::endl;
}
