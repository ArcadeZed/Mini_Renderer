...
// ============================================================================
// VULKAN RESOURCE IMPLEMENTATION
// ============================================================================

void VulkanResource::init(VulkanContext* ctx, VulkanCommand* cmd) {
    context = ctx;
    command = cmd;

    std::cout << "VulkanResource initialized." << std::endl;
}
...
void VulkanResource::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
...
void VulkanResource::createImage(uint32_t width, uint32_t height, uint32_t mipLevels,
...
VkImageView VulkanResource::createImageView(VkImage image, VkFormat format, uint32_t mipLevels) {
...
void VulkanResource::transitionImageLayout(VkImage image, VkFormat format,
...
void VulkanResource::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = command->beginSingleTimeCommands();
